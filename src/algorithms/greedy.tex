...
that this tree is the best possible one that could have been produced. There's
some initial paperwork to be done in order to set up the ideas behind the proof.
